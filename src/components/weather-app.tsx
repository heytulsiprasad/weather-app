  ...
  return (
    <section className="w-full rounded-3xl bg-white/80 p-6 shadow-xl backdrop-blur dark:bg-slate-900/70 sm:p-10">
      ...
      >
        ...
        <button
          type="submit"
          className="flex w-full items-center justify-center rounded-2xl bg-[rgb(var(--color-primary))] px-5 py-3 text-base font-semibold text-white transition hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[rgb(var(--color-primary))] sm:w-auto"
          disabled={isLoading}
        >
      ...
      {weather ? (
        <div className="mt-8 space-y-8">
          <div className="flex flex-col gap-6 rounded-3xl bg-[rgb(var(--color-primary-light))] p-6 dark:bg-slate-800/60 sm:flex-row sm:items-center sm:justify-between">
            <div>
